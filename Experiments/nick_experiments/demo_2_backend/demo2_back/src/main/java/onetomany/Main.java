...
class Main {
    ...
    CommandLineRunner initUser(UserRepository userRepository, LaptopRepository laptopRepository, PhoneRepository phoneRepository) {
        return args -> {
            User user1 = new User("John", "Smith", "john@somemail.com", new Date());
            User user2 = new User("Jane","Anderson" , "jane@somemail.com", new Date());
            User user3 = new User("Justin", "Jefferson" ,"justin@somemail.com", new Date());
